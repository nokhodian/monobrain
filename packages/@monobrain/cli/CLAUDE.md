...
For a comprehensive overview of all Monobrain features, agents, commands, and integrations, see:

**`.monobrain/CAPABILITIES.md`** - Complete reference generated during init

...
## Integration with v1 Neural Module
...
// Record steps...
system.recordStep(taskId, "analyze requirements", 0.8, queryEmbedding);
...
SONA integration follows the same license as the v1 neural module.

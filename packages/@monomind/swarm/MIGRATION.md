...
- ✅ Future-proof (SwarmHub will be removed in v1.1.0+)
- ✅ Cleaner code
...
| ------------ | ------------------------- | -------------------------------- |
| V1.0.0-alpha | Deprecated with warnings  | Start migrating                  |
| V1.0.0-beta  | Legacy compatibility mode | Complete migration               |
| V1.0.0       | Final deprecation notices | Migration recommended            |
| v1.1.0+      | **REMOVED**               | Must use UnifiedSwarmCoordinator |

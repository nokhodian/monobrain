...
```typescript
import { AgentDBBackend } from "@monobrain/memory";
...
```typescript
import { MemoryMigrator } from "@monobrain/memory";
...
- [AgentDB GitHub](https://github.com/nokhodian/agentic-flow/tree/main/packages/agentdb)
- [HNSW Algorithm Paper](https://arxiv.org/abs/1603.09320)
- [v1 Memory Architecture](./README.md)

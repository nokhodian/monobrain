...
describe('PathValidator', () => {
  ...
  describe('isValid', () => {
    ...
    it('should return true for path within allowed directory', () => {
      // Given
      const validPath = './packages/src/security/hasher.ts';
  ...
  describe('isWithinAllowedDirectory', () => {
    it('should return true for path within ./v1/', () => {
      // Given
      const path = './packages/src/security/hasher.ts';
    ...
    it('should normalize path before checking', () => {
      // Given
      const path = './packages/../v1/src/file.ts';
      mockPathUtils.normalize.mockReturnValue('./packages/src/file.ts');

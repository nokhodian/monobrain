...
async function calculateProgress(): Promise<ProgressMetrics> {
...
async function syncProgress(): Promise<ProgressMetrics> {
...
function getSummary(metrics: ProgressMetrics): string {
  const lines = [
    '═══════════════════════════════════════════════════',

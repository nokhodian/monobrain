...
CREATE INDEX IF NOT EXISTS idx_vectors_ns_coll_created
    ON monobrain.vectors (namespace, collection, created_at DESC);

-- Embeddings: namespace + importance + access_count (for prioritization)
CREATE INDEX IF NOT EXISTS idx_embeddings_ns_importance
    ON monobrain.embeddings (namespace, importance DESC, access_count DESC);
...
ANALYZE monobrain.vectors;
ANALYZE monobrain.embeddings;
ANALYZE monobrain.attention_cache;
ANALYZE monobrain.gnn_cache;
ANALYZE monobrain.hyperbolic_embeddings;
ANALYZE monobrain.collections;
...
-- DROP INDEX IF EXISTS monobrain.idx_embeddings_ns_importance;
-- DROP INDEX IF EXISTS monobrain.idx_vectors_ns_coll_created;
--
-- -- Drop partial indices
-- DROP INDEX IF EXISTS monobrain.idx_embeddings_high_importance;
-- DROP INDEX IF EXISTS monobrain.idx_vectors_active;
--
-- -- Drop access pattern indices
-- DROP INDEX IF EXISTS monobrain.idx_gnn_cache_hit_count;
-- DROP INDEX IF EXISTS monobrain.idx_attention_cache_hit_count;
-- DROP INDEX IF EXISTS monobrain.idx_embeddings_access_count;
--
-- -- Drop hierarchy indices
-- DROP INDEX IF EXISTS monobrain.idx_hyperbolic_depth;
-- DROP INDEX IF EXISTS monobrain.idx_hyperbolic_parent;
--
-- -- Drop hash indices
-- DROP INDEX IF EXISTS monobrain.idx_vectors_source;
-- DROP INDEX IF EXISTS monobrain.idx_vectors_hash;
--
-- -- Drop timestamp indices
-- DROP INDEX IF EXISTS monobrain.idx_collections_created_at;
-- DROP INDEX IF EXISTS monobrain.idx_hyperbolic_created_at;
-- DROP INDEX IF EXISTS monobrain.idx_gnn_cache_last_accessed;
-- DROP INDEX IF EXISTS monobrain.idx_gnn_cache_created_at;
-- DROP INDEX IF EXISTS monobrain.idx_attention_cache_last_accessed;
-- DROP INDEX IF EXISTS monobrain.idx_attention_cache_created_at;
-- DROP INDEX IF EXISTS monobrain.idx_embeddings_last_accessed;
-- DROP INDEX IF EXISTS monobrain.idx_embeddings_created_at;
-- DROP INDEX IF EXISTS monobrain.idx_vectors_expires_at;
-- DROP INDEX IF EXISTS monobrain.idx_vectors_updated_at;
-- DROP INDEX IF EXISTS monobrain.idx_vectors_created_at;
--
-- -- Drop namespace indices
-- DROP INDEX IF EXISTS monobrain.idx_collections_namespace;
-- DROP INDEX IF EXISTS monobrain.idx_hyperbolic_namespace;
-- DROP INDEX IF EXISTS monobrain.idx_embeddings_tags_gin;
-- DROP INDEX IF EXISTS monobrain.idx_embeddings_namespace;
-- DROP INDEX IF EXISTS monobrain.idx_vectors_namespace;
-- DROP INDEX IF EXISTS monobrain.idx_vectors_namespace_collection;
--
-- -- Drop GIN indices
-- DROP INDEX IF EXISTS monobrain.idx_collections_metadata_gin;
-- DROP INDEX IF EXISTS monobrain.idx_hyperbolic_metadata_gin;
-- DROP INDEX IF EXISTS monobrain.idx_gnn_cache_metadata_gin;
-- DROP INDEX IF EXISTS monobrain.idx_attention_cache_metadata_gin;
-- DROP INDEX IF EXISTS monobrain.idx_embeddings_metadata_gin;
-- DROP INDEX IF EXISTS monobrain.idx_vectors_metadata_gin;
--
-- -- Drop HNSW indices
-- DROP INDEX IF EXISTS monobrain.idx_embeddings_embedding_hnsw_cosine;
-- DROP INDEX IF EXISTS monobrain.idx_vectors_embedding_hnsw_ip;
-- DROP INDEX IF EXISTS monobrain.idx_vectors_embedding_hnsw_l2;
-- DROP INDEX IF EXISTS monobrain.idx_vectors_embedding_hnsw_cosine;
--
-- DELETE FROM monobrain.migrations WHERE name = '003_create_indices';
-- COMMIT;

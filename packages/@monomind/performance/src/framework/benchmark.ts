/**
 * V1 Performance Benchmark Framework
 *
...
export const V1_PERFORMANCE_TARGETS = {
  // Startup Performance
...
export type PerformanceTarget = keyof typeof V1_PERFORMANCE_TARGETS;
...
export function meetsTarget(
  ...
  const target = V1_PERFORMANCE_TARGETS[benchmarkName as PerformanceTarget];
  if (target === undefined) {

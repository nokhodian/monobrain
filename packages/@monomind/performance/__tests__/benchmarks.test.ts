 ...
 * and V1 performance target validation (2.49x-7.47x speedup).
 */
...
describe('AttentionBenchmarkRunner', () => {
  ...
  describe('validateTargets()', () => {
    it('should validate V1 performance targets', () => {
      const validation = runner.validateTargets();
    ...
    it('should use 512 dimension for validation', () => {
      // Default dimension for V1 validation should be 512
      const validation = runner.validateTargets();

...
- mcp**monobrain**coordination_sync
- TodoWrite
- TodoRead
- Bash
- Grep
...
- Edit
  hooks:
  pre: - "Initialize PR-specific swarm with diff analysis and impact assessment" - "Analyze PR complexity and assign optimal agent topology" - "Store PR metadata and diff context in swarm memory"
  post: - "Update PR with comprehensive swarm review results" - "Coordinate merge decisions based on swarm analysis" - "Generate PR completion metrics and learnings"
